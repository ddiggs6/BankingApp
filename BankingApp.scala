    ...
    def acctDetails(): Unit ={
        ...
        def withdrawal(takeOut: Double): Double={
            ...
            if( takeout > acctBalance){
                println(" Transaction cannot be completed.")
            }else{
            ...
            var transaction = ""
                ...
                if(option ==2){
                   // acctDetails()
                    ...
                    transaction = "Deposit"
                    val statement = connection.createStatement()
                  var option2 = "INSERT INTO BankingApp(Acctnum, Name, Transaction, Balance) VALUES ('"+ acctnum +"','"+ name +"', '"+ transaction +"', "+ acctBalance + ");"
                ...
                if(option == 3){
                   // acctDetails()
                    ...
                    val statement = connection.createStatement()
                    var option3 = "INSERT INTO BankingApp(Acctnum, Name, Transaction, Balance) VALUES ('"+ acctnum +"','"+ name +"', '"+ transaction +"', "+ acctBalance + ");"
